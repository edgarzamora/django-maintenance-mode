...
from maintenance_mode import core, settings, utils, io
    ...
    def process_request(self, request):
        ...
        if settings.MAINTENANCE_MODE or core.get_maintenance_mode():
            ...
            if settings.MAINTENANCE_MODE_IGNORE_IP_ADDRESSES:
                ...
                for ip_address \
                        in settings.MAINTENANCE_MODE_IGNORE_IP_ADDRESSES:
            ...
            if settings.MAINTENANCE_MODE_REDIRECT_URL:
                ...
                if settings.MAINTENANCE_MODE_TEMPLATE_CONTEXT:
                    ...
                    request_context_func = utils.import_function(
                        settings.MAINTENANCE_MODE_TEMPLATE_CONTEXT)

                    if request_context_func:
                        request_context = request_context_func(
                            request=request)
